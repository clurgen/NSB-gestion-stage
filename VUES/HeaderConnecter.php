...
<body>
		<div class="topnav" id="myTopnav">
			...
			<a href="index.php?page=deconnexion" class="login" style="font-size: 17px; padding: 10px 10px; margin: 15px;">Deconnexion</a>

			<div class="drop_down">
				<a href="index.php?page=domiciliation" class="dropbtn mon_compte" style="font-weight: bolder;">
					Mon compte
				</a>
				<div class="dropdown-content" role="menu">
					<div class="ligne">
						<div class="colonne">
							<a href="index.php?page=creationMonEntreprise" style="font-weight: bolder; text-decoration: underline;">Paramètres</a>
							<a href="index.php?page=formulairesGratuits" style="font-weight: bolder; text-decoration: underline;">Mes documents</a>
							<a href="index.php?page=FAQ" style="font-weight: bolder; text-decoration: underline;">FAQ</a> 
						</div>
					</div>
				</div>
